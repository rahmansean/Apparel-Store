...
<div id="carouselExampleCaptions" class="carousel slide abc" data-bs-ride="carousel" data-interval="500">
          ...
          <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <h1>Man Section</h1>
                    <button class="btnHome1 mt-3 ml-2"><a style="text-decoration:none"  href="http://localhost/ApparelStore/m_main.php">Shop Now</button><a>
                </div>
            </div>
          </div>
      </div>
      ...
      <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <h6>Clothing Collection</h6>
                    <h1>Woman Section</h1>
                    <button class="btnHome1 mt-3 ml-2"><a style="text-decoration:none" href="http://localhost/ApparelStore/f_main.php">Shop Now</button></a>
                </div>
            </div>
          </div>
      </div>
      ...
      <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <button class="btnHome1 mt-3 ml-2"><a style="text-decoration:none" href="http://localhost/ApparelStore/child_main.php">Shop Now</button><a>
                </div>
            </div>
          </div>
      </div>
            ...
            <div class="row py-5">
               ...
               <!-- <h4>TK 1,200.00</h4> -->
                ...
                <div class="col-lg-3 text-center">
                    <div class="card border-0 bg-light">
                        <div class="card-body">
                            <img src="image\boy_featured1.jpg" class="img-fluid" alt="Feautred 01">
                        </div>
                    </div>
                 ...
                 <div class="col-lg-12">
                     <div class="row">
                         ...
                         <div class="col-lg-3">
                             ...
                             <button class="btn2">Men's Collection</button>
                             </form>

                             <form action="f_main.php">
                             <button class="btn2">Women's Collection</button>
                             </form>

                             <form action="child_main.php">
                             <button class="btn2">Children's Collection</button>
                             </form>
