...
<body>
	...
	<form action="" method="post"  enctype="multipart/form-data"> 
		 ...
		 <Select class="form-select" name ="Category">
			 ...
			 <option value="boysdress">Boys Dress</option>
			 <option value="boyshoe">Boys Shoes</option>
			 <option value="girldress">Girls Dress</option>
			 <option value="girlshoe">Girls Shoes</option>
			 <option value="childnewarrival">New Arrival</option>
